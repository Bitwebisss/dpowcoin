...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 DPC from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 100 dpc in block rewards plus fees, but
        ...
        # Send 10 DPC with subtract fee from amount
        ...
        # Sendmany 10 DPC with subtract fee from amount
        ...
        # Sendmany 5 DPC to two addresses with subtracting fee from both addresses
        ...
        if not self.options.descriptors:
            ...
            # This will raise an exception for attempting to get the private key of an invalid Dpowcoin address
            assert_raises_rpc_error(-5, "Invalid Dpowcoin address", self.nodes[0].dumpprivkey, "invalid")

            # This will raise an exception for attempting to set a label for an invalid Dpowcoin address
            assert_raises_rpc_error(-5, "Invalid Dpowcoin address", self.nodes[0].setlabel, "invalid address", "label")

            # This will raise an exception for importing an invalid address
            assert_raises_rpc_error(-5, "Invalid Dpowcoin address or script", self.nodes[0].importaddress, "invalid")
